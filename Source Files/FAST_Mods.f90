...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Include tuned mass damper degrees of freedom.
!mal Make the x-direction TMD the 25th DOF, and the y-direction TMD the 26th DOF
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal create number of DOF variables for the TMDs and pointer arrays
INTEGER(4)                   :: NPTmdXE                                         ! Number of DOFs                  that contribute to the QD2T-related linear accelerations of the TmdX center of mass                                                          (point U) in the inertia frame, based on which DOFs are presently enabled.
INTEGER(4), ALLOCATABLE      :: PTmdXE      (:)                                 ! Array of DOF indices (pointers) that contribute to the QD2T-related linear accelerations of the TmdX center of mass                                                          (point U) in the inertia frame, based on which DOFs are presently enabled.
INTEGER(4)                   :: NPTmdYE                                         ! Number of DOFs                  that contribute to the QD2T-related linear accelerations of the TmdY center of mass                                                          (point U) in the inertia frame, based on which DOFs are presently enabled.
INTEGER(4), ALLOCATABLE      :: PTmdYE      (:)                                 ! Array of DOF indices (pointers) that contribute to the QD2T-related linear accelerations of the TmdY center of mass   
!mal End of proposed change.  v6.10a-mal  1-Mar-2009.
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Add feature for modeling two TMDs in the nacelle.
LOGICAL                   :: TmdXDOF   = .FALSE.                             ! Axial TMD DOF. (Initialize to .FALSE. b/c not all models will use a TMD)
LOGICAL                   :: TmdYDOF   = .FALSE.                             ! Transverse TMD DOF. (Initialize to .FALSE. b/c not all models will use a TMD)
!mal End of proposed change.  v6.10a-mal  1-Mar-2009.
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Include initial deflections of the TMDs
REAL(ReKi)                   :: TmdXDsp   = 0.0                                 ! Initial or fixed displacement of the axial TMD. (Initialized to zero b/c not all models use a TMD)
REAL(ReKi)                   :: TmdXDspInit = 0.0                               ! Initial or fixed displacement of the axial TMD. (Initialized to zero b/c not all models use a TMD)
REAL(ReKi)                   :: TmdXSprInit = 0.0                               ! Initial or fixed spring stiffness of the axial TMD. (Initialized to zero b/c not all models use a TMD)
REAL(ReKi)                   :: TmdXDampInit  = 0.0                             ! Initial or fixed damping of the axial TMD. (Initialized to zero b/c not all models use a TMD)

REAL(ReKi)                   :: TmdYDsp   = 0.0                                 ! Initial or fixed displacement of the transverse TMD. (Initialized to zero b/c not all models use a TMD)
REAL(ReKi)                   :: TmdYDspInit = 0.0                               ! Initial or fixed displacement of the axial TMD. (Initialized to zero b/c not all models use a TMD)
REAL(ReKi)                   :: TmdYSprInit = 0.0                               ! Initial or fixed spring stiffness of the transverse TMD. (Initialized to zero b/c not all models use a TMD)
REAL(ReKi)                   :: TmdYDampInit  = 0.0                             ! Initial or fixed damping of the transverse TMD. (Initialized to zero b/c not all models use a TMD)
!mal End of proposed change.  v6.10a-mal  1-Mar-2009.
